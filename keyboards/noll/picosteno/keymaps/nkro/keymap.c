...
// Most of this is not required for the Picosteno, but it has been ported
// from the Ecosteno/Multisteno with minimal changes
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // you only need to worry about STENO and NKRO here
  [STENO] = LAYOUT(
                    STN_N2,                                     STN_N6,
  ...
  [NKRO] = LAYOUT(
    ...
    KC_A, KC_S, KC_D, KC_F,               KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
                      KC_C, KC_V,   KC_N, KC_M 
  ),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    // this is for the Ecosteno/Multisteno
