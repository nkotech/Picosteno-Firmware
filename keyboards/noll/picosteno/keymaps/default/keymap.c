...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [STENO] = LAYOUT(
    ...
    STN_S2,         STN_KL, STN_WL, STN_RL,                     STN_RR, STN_BR, STN_GR, STN_SR, STN_ZR,
                                        STN_A,  STN_O,     STN_E,  STN_U 
  ),

  // [STENO] = LAYOUT(
  //               STN_N2,         /*STN_N4,*/                                     /*STN_N8,*/         STN_NA,
  //   TO(NKRO),           STN_TL, STN_PL, STN_HL, STN_ST1,   STN_ST3, STN_FR, STN_PR, STN_LR, STN_TR, STN_DR,
  //   MO(SYMBOL),         STN_KL, STN_WL, STN_RL,                     STN_RR, STN_BR, STN_GR, STN_SR, STN_ZR,
  //                                       STN_A,  STN_O,     STN_E,  STN_U 
  // ),

  [NKRO] = LAYOUT(
                KC_2,       /*KC_4,*/                           /*KC_8,*/       KC_0,
    TO(QWERTY),       KC_W, KC_E, KC_R, KC_T,   KC_Y, KC_U, KC_I, KC_O, KC_P,    KC_LBRC,
    MO(SYMBOL),       KC_S, KC_D, KC_F,               KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
                                  KC_C, KC_V,   KC_N, KC_M 
  ),

  [QWERTY] = LAYOUT(
                KC_TAB,         /*KC_ESC,*/                                /*KC_ENTER,*/        KC_BSPC,
    TO(STENO),          KC_W,   KC_E, KC_R,    KC_T,       KC_Y, KC_U, KC_I,    KC_O,   KC_P,     KC_QUOT,
    MO(SYMBOL),         KC_X,   KC_C, KC_V,                      KC_M, KC_COMM, KC_DOT, KC_SLASH, MO(QWERTY_CAPS),
                                      KC_LCTL, KC_SPACE,   KC_SPACE, KC_RALT 
  ),

  [QWERTY_CAPS] = LAYOUT(
                S(KC_TAB),        /*S(KC_ESC),  */                                   /*S(KC_ENTER),  */         S(KC_BSPC),
    TO(STENO),           S(KC_W), S(KC_E), S(KC_R), S(KC_T),   S(KC_Y), S(KC_U), S(KC_I),    S(KC_O),   S(KC_P),     S(KC_QUOT),
    MO(SYMBOL),          S(KC_X), S(KC_C), S(KC_V),                     S(KC_M), S(KC_COMM), S(KC_DOT), S(KC_SLASH), KC_RSFT,
                                          KC_LCTL, KC_SPACE,   KC_SPACE, KC_RALT 
  ),

  [SYMBOL] = LAYOUT(
             KC_HASH,          /*KC_DOLLAR,*/                                       /*KC_LPRN,*/            KC_RPRN,
             KC_EXLM, KC_AT,   KC_LT,   KC_GT,   KC_BSLS,  KC_DQT,   KC_PLUS, KC_MINS,  KC_SLASH, KC_ASTR, KC_TAB,
             KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC,                       KC_AMPR, KC_EQUAL, KC_COMM,  KC_DOT,  KC_RSFT,
